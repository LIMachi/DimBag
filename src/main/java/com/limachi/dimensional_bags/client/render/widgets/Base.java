...
public class Base implements IRenderable {
    ...
    public Base(BaseScreen<?> screen, Base parent, Box2d coords, boolean isCut) {
        this.screen = screen;
        this.parent = parent;
        if (parent == null)
    ...
    public Base(BaseScreen<?> screen, Base parent, double x, double y, double width, double height, boolean isCut) {
