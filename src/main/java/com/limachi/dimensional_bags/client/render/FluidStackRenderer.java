...
/**
 * @link https://https://github.com/mezz/JustEnoughItems/blob/1.16/src/main/java/mezz/jei/plugins/vanilla/ingredients/fluid/FluidStackRenderer.java
 */
public class FluidStackRenderer implements IIngredientRenderer<FluidStack> {
    ...
    public static final FluidStackRenderer INSTANCE = new FluidStackRenderer(1, TooltipMode.SHOW_AMOUNT, TEX_WIDTH, TEX_HEIGHT, null); //renders a fluid full, with the size of a standard item stack
