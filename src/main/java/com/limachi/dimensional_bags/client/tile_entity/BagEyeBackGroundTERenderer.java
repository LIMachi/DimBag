package com.limachi.dimensional_bags.client.tile_entity;
...
/**
 * riped from original minecraft code to render end portals
 * see EndPortalTileEntityRenderer.java and RenderType.class
 */

@OnlyIn(Dist.CLIENT)
public class BagEyeBackGroundTERenderer<T extends EndPortalTileEntity> extends TileEntityRenderer<T> {
    ...
    public BagEyeBackGroundTERenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
