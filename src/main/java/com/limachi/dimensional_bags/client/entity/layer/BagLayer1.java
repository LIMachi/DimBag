...
public class BagLayer1<T extends PlayerEntity, M extends BipedModel<T>> extends LayerRenderer<T, M> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(MOD_ID, "textures/entity/bag1_entity.png");
...
//        Item item = player.inventory.getCurrentItem().getItem();
        ...
        if (item instanceof Bag)
        {
            ...
            this.model.VoxelShapes.copyModelAngles(this.getEntityModel().bipedBody);
