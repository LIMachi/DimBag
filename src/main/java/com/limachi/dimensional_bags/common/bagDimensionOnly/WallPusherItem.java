...
@StaticInit
public class WallPusherItem extends Item implements IDimBagCommonItem {

    public static String NAME = "wall_pusher";

    static {
        Registries.registerItem(NAME, WallPusherItem::new);
    }

    public WallPusherItem() { super(DimBag.DEFAULT_PROPERTIES); }
