...
public class TankInventory implements ISimpleFluidHandlerSerializable, IFluidTank {
    ...
    public void reload(TankInventory tank) {
    ...
    public boolean equals(Object o) {
        ...
        TankInventory that = (TankInventory) o;
