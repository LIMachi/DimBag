...
@StaticInit
public abstract class LivingEntityWatcher {

    static {
        EntityWatcher.register(LivingEntity.class, "health", LivingEntity::getHealth);
        EntityWatcher.register(LivingEntity.class, "max_health", LivingEntity::getMaxHealth);
        /*
