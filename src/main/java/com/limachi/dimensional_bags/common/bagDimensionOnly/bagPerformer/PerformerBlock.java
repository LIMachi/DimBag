...
@StaticInit
public class PerformerBlock extends AbstractTileEntityBlock<PerformerTileEntity> {

    public static final String NAME = "performer";

    public static final Supplier<PerformerBlock> INSTANCE = Registries.registerBlock(NAME, PerformerBlock::new);
    ...
    public PerformerBlock() { super(NAME, Properties.of(Material.HEAVY_METAL).sound(SoundType.STONE).strength(1.5F, 180000000).isValidSpawn((s, r, p, e)->false), PerformerTileEntity.class, PerformerTileEntity.NAME); }
    ...
    @Override
    public <B extends AbstractTileEntityBlock<PerformerTileEntity>> B getInstance() { return (B)INSTANCE.get(); }
    ...
    @Nullable
    @Override
    public TileEntity newBlockEntity(@Nonnull IBlockReader worldIn) { return Registries.getBlockEntityType(PerformerTileEntity.NAME).create(); }
    ...
    public static void setPowered(World world, BlockPos pos, boolean state) {
        if (world.getBlockState(pos).getBlock() instanceof PerformerBlock && isPowered(world.getBlockState(pos)) != state)
    ...
    public void neighborChanged(BlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos, boolean isMoving) {
        if (!worldIn.isClientSide()) {
            ...
            if (tileentity instanceof PerformerTileEntity) {
                PerformerTileEntity ghosthand = (PerformerTileEntity)tileentity;
