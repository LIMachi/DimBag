...
public class Debug extends Mode {
    ...
    public ActionResultType onItemUse(EyeData data, ItemUseContext context) { LOGGER.info("onItemUse"); return ActionResultType.SUCCESS; }
    public ActionResult<ItemStack> onItemRightClick(EyeData data, World world, PlayerEntity player, Hand hand) { LOGGER.info("onItemRightClick"); return new ActionResult<>(ActionResultType.SUCCESS, player.getHeldItem(hand)); }
