...
public class HolderData extends WorldSavedDataManager.EyeWorldSavedData {
    ...
    /**
     * @return the uuid of the holder, the entity isn't required to be loaded/valid, return HolderData.NULLID as an invalid/unset holder (aka new UUID(0,0))
     */
    ...
    public void read(CompoundNBT nbt) {
        ...
        if (!id.equals(NULLID) && lastKnownPosition != null && lastKnownDimension != null)
            getEntityForceLoad();
    }
