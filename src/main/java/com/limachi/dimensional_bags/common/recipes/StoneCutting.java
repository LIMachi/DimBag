...
public class StoneCutting extends StonecuttingRecipe implements IRecipe {
    ...
    public StoneCutting(ResourceLocation name, Ingredient ingredient, Function<IInventory, ItemStack> result) {
        this(null, ingredient, result, name);
    }

    private StoneCutting(ResourceLocation idIn, Ingredient ingredient, Function<IInventory, ItemStack> result, ResourceLocation name) {
    ...
    public StoneCutting cloneWithId(ResourceLocation id) { return new StoneCutting(id, this.ingredient, RESULT, NAME); }
    ...
    public IRecipeSerializer<?> getSerializer() {
        class AdvancedRecipeSerializer extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<StoneCutting> {
            ...
            public AdvancedRecipeSerializer(StoneCutting craft) { this.craft = craft; }

            @Override
            @Nonnull
            public StoneCutting read(@Nonnull ResourceLocation recipeId, @Nonnull JsonObject json) { return craft.cloneWithId(recipeId); }

            @Override
            @Nullable
            public StoneCutting read(@Nonnull ResourceLocation recipeId, @Nonnull PacketBuffer buffer) { return craft.cloneWithId(recipeId); }
