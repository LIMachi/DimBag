...
/**
 * universal handler for a bag (energy, items and fluid), note that all handles are weak, if a handle is lost, the proxy will behave as though it was an empty energy/item/fluid handler
 */
public class BagProxy implements IEnergyStorage, IItemHandler, IFluidHandler, ICapabilityProvider {
    ...
    final public int getEyeID() { return eyeId; }

    final public BagProxy setEyeID(int eye) {
        eyeId = eye;
