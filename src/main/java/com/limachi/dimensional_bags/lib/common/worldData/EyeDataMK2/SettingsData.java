...
//                }
    ...
    public void initDefaultSettings() {
        ...
        ModeManager.getMode("Default").settingsReader.set("bag_name", this, new TranslationTextComponent("item.dim_bag.bag").getString() + " " + getbagId());
    }

    public String getBagName() { /*return settingsNbt.getString("BagName");*/
        return ModeManager.getMode("Default").getSetting(getbagId(), "bag_name");
    }
